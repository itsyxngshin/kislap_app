...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // FIX: Integration of the Quantity Multiplier for calculations
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            isPh ? 'Konsumo ngayon' : "Today's draw",
                            style: TextStyle(
                              color: hintColor,
                              fontSize: 11,
                              height: 1.3,
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            isPh ? 'Est. gastos ngayon' : "Est. cost today",
                            style: TextStyle(
                              color: hintColor,
                              fontSize: 11,
                              height: 1.3,
              ...
              // NEW: Header with Inline Sort Dropdown
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(
                  ...
                  Row(
                    children: [
                      Text(
                        '${devices.length} ${isPh ? 'gamit' : 'items'}',
              ...
              if (devices.isEmpty)
                ...
                ListView.builder(
                  ...
                  itemCount: sortedDevices.length, // Render sorted array
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      systemBreached
                          ? (isPh ? 'Sumobra' : 'Over Budget')
                          : (isPh ? 'Pasok sa Limit' : 'On Track'),
                      style: TextStyle(
                        color: statusColor,
                        fontSize: 11,
                        fontWeight: FontWeight.bold,
  ...
  Widget _buildApplianceCard(
    ...
    // FIX: Calculate including the item.quantity
    final double originalDailyKwh =
        (item.presetWattage * item.quantity / 1000) * item.userAssignedHours;
    final double optimizedDailyKwh =
        (item.presetWattage * item.quantity / 1000) * item.adjustedHours;
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: isLocked
                  ? AppColors.appYellow.withOpacity(0.1)
                  : surfaceColor,
              shape: BoxShape.circle,
            ),
            child: Icon(
              _getApplianceIcon(item.customName),
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                // Display Quantity inline with Name
                Text(
          ...
          Column(
            ...
            children: [
              Text(
                _formatTime(item.adjustedHours),
                style: const TextStyle(
                  color: Colors.greenAccent,
                  fontSize: 15,
                  fontWeight: FontWeight.bold,
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Icon(
              icon,
              color: isPrimary ? Colors.white : hintColor,
              size: 28,
            ),
          ),
