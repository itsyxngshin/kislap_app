...
class _GuestSetupScreenState extends ConsumerState<GuestSetupScreen> {
  ...
  String _getPreviousBillingMonth(bool isPh) {
    ...
    return isPh
        ? '${monthsPh[prevMonth - 1]} $prevYear'
        : '${monthsEn[prevMonth - 1]} $prevYear';
  }
  ...
  Future<void> _submitGuestSetup() async {
    ...
    try {
      ...
      final String prevPeriodName = isPh
          ? '${monthsPh[prevMonth - 1]} $prevYear'
          : '${monthsEn[prevMonth - 1]} $prevYear';
      ...
      if (mounted) {
        showDialog(
          ...
          builder: (ctx) => AlertDialog(
            ...
            title: Text(
              isPh ? 'Matagumpay na Nai-save!' : 'Setup Complete!',
              style: TextStyle(
            ...
            actions: [
              TextButton(
                ...
                child: Text(
                  isPh ? 'Mamaya na' : 'Skip for now',
                  style: const TextStyle(color: AppColors.appYellow),
                ),
              ),
              FilledButton(
                onPressed: () {
                  ...
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (_) => OnboardingDevicesScreen(),
                    ),
                  );
                },
                ...
                child: Text(
                  isPh ? 'Magdagdag ng Gamit' : 'Add Appliances',
              ...
              child: Stepper(
                ...
                steps: [
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                isPh
                                    ? 'Magkano ang limitasyon mo ngayong buwan?'
                                    : 'How much are you willing to spend this month?',
                                style: TextStyle(
                                  color: hintColor,
                                  fontSize: 12,
                                  height: 1.4,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                isPh
                                    ? 'NAKARAANG HALAGA (PREVIOUS RATE)'
                              ...
                              Text(
                                isPh
                                    ? 'Suriin ang electric bill noong nakaraang ${_getPreviousBillingMonth(true)} para sa eksaktong ₱/kWh.'
                                    : 'Check your electric bill from ${_getPreviousBillingMonth(false)} for the exact ₱/kWh rate.',
                                style: TextStyle(
                                  color: hintColor,
                                  fontSize: 12,
                                  height: 1.4,
                  ...
                  Step(
                    ...
                    subtitle: Text(
                      isPh ? 'Antas ng paggamit' : 'Sets the kVA scale',
                      style: TextStyle(color: hintColor, fontSize: 12),
                    ),
                    ...
                    content: Column(
                      ...
                      children: [
                        ...
                        Text(
                          isPh
                              ? 'Piliin ang uri ng bahay upang matukoy ang limitasyon sa kuryente.'
                          ...
                          child: Column(
                            children: [
                              ...
                              _buildRadioOption(
                                'Large (16 - 25 kVA)',
                                isPh
                                    ? 'Malakas na konsumo. Maraming aircon at malaking gamit.'
